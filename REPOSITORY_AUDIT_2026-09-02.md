...
explicación completa está en `ARCHITECTURE.md` y el procedimiento de placa en
...
1. El README raíz ya no afirma que el superproyecto contiene sólo gitlinks:
   documenta `scripts/`, `Assets/`, snapshots web y el modelo directo del
   martinete.
2. `ARCHITECTURE.md` refleja UART de bajada, I2C de subida y SYNC dedicado.
3. `MIGRATION.md` distingue la modularización del 20 de julio de la
...
- `modelado/matlab/martinete_leva_multibody/` sigue versionado directamente en
  la raíz pese a existir el repositorio `src/calculos_modelados/matlab`.
...
commit: README del repositorio dueño, `ARCHITECTURE.md` si cruza sectores y esta
